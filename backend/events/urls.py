...
from .views import GetRoutesView, AllEventsView, EventCreateView, EventDetailsView , SearchView, MarkInterestedView, InterestedDetailView, RatingView, ReviewView, EventImageView
urlpatterns = [
